...
const seed = [
  ...
  m({ folder: 'inbox', unread: true,  starred: false, label: 'work',     from: 'GitHub',       fromEmail: 'noreply@github.com', subject: 'PR #248 ready for review',      preview: 'feat(dashboard): wire chart tabs to data source', body: 'Pull request #248 by @adam is ready for your review.\n\nfeat(dashboard): wire chart tabs to data source\n\n3 files changed, 47 additions, 12 deletions.\n\nView on GitHub →', time: '8:14 AM' }),
  ...
  m({ folder: 'inbox', unread: false, starred: false, label: null,       from: 'Vercel',       fromEmail: 'updates@vercel.com', subject: 'Deployment succeeded',          preview: 'dash.vercel.app deployed in 28s', body: 'Production deployment for dash succeeded.\n\nDuration: 28s\nCommit: e08f69c — Release 2.2.0 — fresh for 2026\n\nView deployment →', time: 'Tue' }),
  m({ folder: 'inbox', unread: false, starred: false, label: 'work',     from: 'Adam S.',    fromEmail: 'user@example.com', subject: 'Draft for landing copy',        preview: 'Take a look when you get a chance — happy to iterate.', body: 'First pass at the landing copy:\n\n> The free Bootstrap admin template, redesigned for 2026.\n> Fresh design system. Real ECharts. Real DataTables. Vite 8, vanilla JS, zero jQuery.\n\nHappy to iterate. — A.', time: 'Mon' }),
  m({ folder: 'inbox', unread: false, starred: false, label: null,       from: 'Notion',       fromEmail: 'team@notion.com', subject: 'Mentioned in Q2 OKRs',          preview: '@you was mentioned in the new Q2 OKRs document.', body: 'You were mentioned in:\n\nQ2 OKRs — 2026\n  > … @adam to drive the v4 release and migration playbook.\n\nView document →', time: 'Apr 23' }),
  ...
  m({ folder: 'inbox', unread: false, starred: false, label: 'promotions', from: 'Figma',     fromEmail: 'team@figma.com', subject: '🎁 Your design tools, refreshed',  preview: 'New plugins, faster autosave, and AI features.', body: "Hi Adam,\n\nWe shipped a bunch of stuff this month — autosave got 4× faster, plugins now run in a sandboxed worker, and our AI assist is in open beta.\n\nWhat's new →", time: 'Apr 20' }),
  m({ folder: 'inbox', unread: false, starred: false, label: 'urgent',   from: 'Security',     fromEmail: 'security@example.com', subject: 'Action required: 2FA reset',     preview: 'Please confirm your 2FA codes have been backed up.', body: "We rotated the 2FA seed for your account on Apr 19.\n\nIf you haven't done so already, please confirm your backup codes are saved somewhere safe. Without them you may be locked out if you lose your device.\n\nReview backup codes →", time: 'Apr 19' }),
  ...
  m({ folder: 'sent', unread: false, starred: false, label: 'work',     from: 'Me',  to: 'team@example.com', subject: 'v4 release plan',             preview: 'Cutting the beta tag tomorrow if no blockers come in.', body: 'Quick update — cutting v4.0.0-beta.1 tomorrow morning unless something blocks. PR list and release notes in the doc.\n\n— A.', time: 'Mon' }),
  ...
  // ── Drafts
  m({ folder: 'drafts', unread: false, starred: false, label: null,     from: 'Me', to: 'user@example.com', subject: 'Re: Draft for landing copy',  preview: 'Two suggestions on the subhead — instead of …', body: "Two suggestions on the subhead:\n\n1. Lead with the year-anchor (\"redesigned for 2026\") earlier — it's the strongest signal.\n2. \"Real charts. Real tables.\" reads stronger as one beat.", time: 'Today' }),
