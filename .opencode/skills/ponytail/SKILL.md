---
name: ponytail
description: Forces the laziest solution that actually works. YAGNI, stdlib before custom code, native before deps, one line before fifty. Use on any coding task or when user says "ponytail", "be lazy", "simplest solution", "yagni", "do less". Not for non-coding requests.
